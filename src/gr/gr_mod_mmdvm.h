...
gr_mod_mmdvm_sptr make_gr_mod_mmdvm(int sps=50, int samp_rate=MMDVM_SAMPLE_RATE, int carrier_freq=1700,
                                          int filter_width=8000);

class gr_mod_mmdvm : public gr::hier_block2
{
public:
    explicit gr_mod_mmdvm(int sps=50, int samp_rate=MMDVM_SAMPLE_RATE, int carrier_freq=1700,
                             int filter_width=8000);
