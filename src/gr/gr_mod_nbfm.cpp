                      ...
                      gr::io_signature::make (1, 1, sizeof (gr_complex)))
{
    ...
    _audio_filter = gr::filter::fft_filter_fff::make(
                1,gr::filter::firdes::low_pass_2(
                    1, target_samp_rate, 3500, 200, 35, gr::filter::firdes::WIN_BLACKMAN_HARRIS));
    ...
    std::vector<float> if_taps = gr::filter::firdes::low_pass_2(25, if_samp_rate * 4,
                        _filter_width, 3500, 60, gr::filter::firdes::WIN_BLACKMAN_HARRIS);
    ...
    _filter = gr::filter::fft_filter_ccf::make(1,gr::filter::firdes::low_pass_2(
                1, if_samp_rate, _filter_width, 3500, 60, gr::filter::firdes::WIN_BLACKMAN_HARRIS));
...
void gr_mod_nbfm::set_ctcss(float value)
{
    ...
    else
    {
        ...
        _audio_filter->set_taps(gr::filter::firdes::band_pass_2(
                                    1, target_samp_rate, 300, 3500, 200, 35, gr::filter::firdes::WIN_BLACKMAN_HARRIS));
