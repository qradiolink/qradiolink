                      ...
                      gr::io_signature::make (1, 1, sizeof (gr_complex)))
{
    ...
    std::vector<float> interp_taps = gr::filter::firdes::low_pass_2(125, 125 * target_samp_rate,
                        _filter_width, 2000, 60, gr::filter::firdes::WIN_BLACKMAN_HARRIS);
    _resampler = gr::filter::rational_resampler_base_ccf::make(125,12, interp_taps);
