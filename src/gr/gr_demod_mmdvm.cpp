                      ...
                      gr::io_signature::makev (1, 1, signature))
{
    ...
    std::vector<float> taps = gr::filter::firdes::low_pass_2(24, 24 * _samp_rate, _filter_width,
                                2000, 90, gr::fft::window::WIN_BLACKMAN_HARRIS);
    _resampler = gr::filter::rational_resampler_ccf::make(24,250, taps);
    ...
    _filter = gr::filter::fft_filter_ccf::make(1,gr::filter::firdes::low_pass_2(
                1, _target_samp_rate, _filter_width, 2000, 90, gr::fft::window::WIN_BLACKMAN_HARRIS));
