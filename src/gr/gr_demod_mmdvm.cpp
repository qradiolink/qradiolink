                      ...
                      gr::io_signature::makev (1, 1, signature))
{
    ...
    std::vector<float> taps = gr::filter::firdes::low_pass_2(12, 12 * _samp_rate, _filter_width,
                                2000, 60, gr::filter::firdes::WIN_BLACKMAN_HARRIS);
    _resampler = gr::filter::rational_resampler_base_ccf::make(12,125, taps);
    ...
    _filter = gr::filter::fft_filter_ccf::make(1,gr::filter::firdes::low_pass_2(
                1, _target_samp_rate, _filter_width, 2000, 60, gr::filter::firdes::WIN_BLACKMAN_HARRIS));


    connect(self(),0,_resampler,0);
    connect(_resampler,0,_rssi_tag_block,0);
    connect(_rssi_tag_block,0,_filter,0);
