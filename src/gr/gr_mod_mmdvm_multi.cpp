                      ...
                      gr::io_signature::make (1, 1, sizeof (gr_complex)))
{
    ...
    std::vector<float> intermediate_interp_taps = gr::filter::firdes::low_pass_2(5, intermediate_samp_rate,
    ...
    _resampler1 = gr::filter::rational_resampler_base_ccf::make(5,1, intermediate_interp_taps);
    _resampler2 = gr::filter::rational_resampler_base_ccf::make(5,1, intermediate_interp_taps);
    _final_resampler = gr::filter::rational_resampler_base_ccf::make(_sps,3, interp_taps);
    ...
    _divide_level = gr::blocks::multiply_const_cc::make(0.4);
    ...
    //connect(_mmdvm_flow_pad,0,_short_to_float1,0);
    //connect(_mmdvm_flow_pad,1,_short_to_float1,0);
