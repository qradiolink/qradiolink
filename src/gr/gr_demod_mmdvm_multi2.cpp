                      ...
                      gr::io_signature::make (0, 0, sizeof (short)))
{
    ...
    std::vector<float> taps = gr::filter::firdes::low_pass_2(1, _samp_rate, _filter_width,
                                2000, 60, gr::filter::firdes::WIN_BLACKMAN_HARRIS);
    std::vector<float> intermediate_interp_taps = gr::filter::firdes::low_pass_2(1, intermediate_samp_rate,
                        _filter_width, 2000, 60, gr::filter::firdes::WIN_BLACKMAN_HARRIS);
    std::vector<float> filter_taps = gr::filter::firdes::low_pass_2(
                1, target_samp_rate, _filter_width, 2000, 60, gr::filter::firdes::WIN_BLACKMAN_HARRIS);
    ...
    {
        _resampler[i] = gr::filter::rational_resampler_base_ccf::make(24, 25, intermediate_interp_taps);
    ...
    for(int i=0;i < 10 - _num_channels;i++)
    {
        connect(_channelizer, 4 + i, _null_sink[i], 0);
    }
}
