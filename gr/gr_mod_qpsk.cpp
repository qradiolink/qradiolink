...
gr_mod_qpsk_sptr make_gr_mod_qpsk(int sps, int samp_rate, int carrier_freq,
                                          int filter_width)
{
    return gnuradio::get_initial_sptr(new gr_mod_qpsk(sps, samp_rate, carrier_freq,
                                                      filter_width));
}

gr_mod_qpsk::gr_mod_qpsk(int sps, int samp_rate, int carrier_freq,
                                 int filter_width) :
...
void gr_mod_qpsk::set_bb_gain(float value)
{
