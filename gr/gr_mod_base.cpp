    ...
    QObject(parent)
{
    ...
    _bpsk_2k = make_gr_mod_bpsk_sdr(125, 500000, 1700, 2400);
    ...
    _qpsk_10k = make_gr_mod_qpsk_sdr(50, 250000, 1700, 3000);
    _qpsk_250k = make_gr_mod_qpsk_sdr(8, 1000000, 1700, 75000);
    _qpsk_video = make_gr_mod_qpsk_sdr(2, 250000, 1700, 75000);
