    ...
    QObject(parent)
{
    ...
    _qpsk_2k = make_gr_mod_qpsk_sdr(500, 1000000, 1700, 1400);
    _qpsk_10k = make_gr_mod_qpsk_sdr(100, 1000000, 1700, 7200);
    _qpsk_250k = make_gr_mod_qpsk_sdr(4, 1000000, 1700, 156000);
    _qpsk_video = make_gr_mod_qpsk_sdr(4, 1000000, 1700, 150000);
