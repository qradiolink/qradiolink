...
void gr_modem::initTX(int modem_type)
{
    ...
    {
        _gr_mod_qpsk_sdr = new gr_mod_qpsk_sdr(0, 25, 250000, 1700, 7000, 1, _requested_frequency_hz, 50);
        _frame_length = 97;
...
void gr_modem::initRX(int modem_type)
{
    ...
    {
        _gr_demod_qpsk_sdr = new gr_demod_qpsk_sdr(_const_gui,_rssi_gui, 0,250,1000000,1700,900,1, _requested_frequency_hz, 50);
        _bit_buf_len = 7 *8;
        _frame_length = 7;
        _bit_buf = new unsigned char[_bit_buf_len];
        _gr_demod_qpsk_sdr->start();
