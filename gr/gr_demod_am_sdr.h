...
class gr_demod_am_sdr : public QObject
{
    Q_OBJECT
public:
    explicit gr_demod_am_sdr(gr::qtgui::sink_c::sptr fft_gui, gr::qtgui::const_sink_c::sptr const_gui, gr::qtgui::number_sink::sptr rssi_gui, QObject *parent = 0, int samp_rate=8000, int carrier_freq=1600,
