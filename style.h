...
static const QString night_stylesheet =
        ...
        "QWidget, QTabWidget, QFrame {background-color:#505a62; color:#ffffd3;}"
        ...
        "QPushButton:checked {background-color:#4a5053; color:#ffffd3;border-style:inset;}"
        ...
        "QComboBox QAbstractItemView {border:1px solid grey;selection-background-color: #d0dae4; color: #f0f077; background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #0a619c, stop: 1.0 #1487ce);}"
...
static const QString day_stylesheet =
        ...
        "QFrame {background-color:#d0dae4; color:#000000}"
        ...
        "QPushButton:checked {background-color: #a3d4f1; border-style:inset;}"
