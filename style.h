...
static const QString night_stylesheet =
        ...
        "QFrame#controlsFrame, QFrame#ledFrame, QFrame#mumbleControlsFrame, QFrame#freqEditFrame, QFrame#shiftEditFrame {border-radius:6px;border:1px solid darkgrey;}"
