...
static const QString day_stylesheet =
        ...
        "QComboBox:on QAbstractItemView {border:1px solid grey;selection-background-color: lightgray; color: #f0f077; background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #0000a3, stop: 1.0 #000043);}"
        "QComboBox::drop-down {border: 0px solid gray;image:url(\":/res/go-down-arrow.png\");subcontrol-origin: padding;subcontrol-position: right;margin-right:4px;}"
