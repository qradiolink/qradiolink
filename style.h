...
static const QString night_stylesheet =
        ...
        "QPushButton {background-color:qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #555555, stop: 0.4 #747474, stop: 0.5 #6a6a6a, stop: 1.0 #555555); color:#ffffd3;"
            "border-radius: 4px;border:1px solid gray;border-style:outset;margin:2px;padding:5px;}"
        "QPushButton:hover {background-color:#000043; color:#ffffd3;}"
        ...
        "QComboBox {border: 1px solid gray; border-style: outset;border-radius: 5px; color: #f0f077; padding: 3px 6px 3px 6px; background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #0000a3, stop: 1.0 #000043);}"
...
static const QString day_stylesheet =
        "QTabBar::tab { background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #bebebe, stop: 0.3 #e4e4e4, stop: 0.7 #c7c7c7, stop: 1.0 #bebebe); color: #000000; padding: 8px; padding-left: 20px;padding-right: 20px;"
        ...
        "QPushButton {margin:2px;background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #bebebe, stop: 0.4 #e4e4e4, stop: 0.5 #c7c7c7, stop: 1.0 #bebebe);padding:5px; border: 1px solid gray; border-style: outset; border-radius:4px;}"
        ...
        "QDial:hover {background-color:#002c86; color:#ffffd3}"
        "QComboBox {border: 1px solid #aaaaaa; border-style: outset;border-radius: 6px; color: #f0f077; padding: 3px 6px 3px 6px; background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #0000a3, stop: 1.0 #000043);}"
        "QComboBox QAbstractItemView {selection-background-color: lightgray; color: #f0f077; background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #0000a3, stop: 1.0 #000043);}"
        "QComboBox::drop-down {border: 0px solid gray;image:url(\":/res/go-down-arrow.png\");subcontrol-origin: padding;subcontrol-position: right;margin-right:4px;}"
